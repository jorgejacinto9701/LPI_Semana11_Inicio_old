...
public class FrmReporteGraficoPorEstado extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmReporteGraficoPorEstado frame = new FrmReporteGraficoPorEstado();
	 ...
	 * Create the frame.
	 */
	public FrmReporteGraficoPorEstado() {
		...
		JLabel lblTitulo = new JLabel("Reporte Gr\u00E1fico por estado");
