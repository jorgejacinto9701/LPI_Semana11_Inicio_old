...
public class FrmReporteGraficoPorEstadoAnio extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmReporteGraficoPorEstadoAnio frame = new FrmReporteGraficoPorEstadoAnio();
	...
	public FrmReporteGraficoPorEstadoAnio() {
		...
		JLabel lblTitulo = new JLabel("Reporte Gr\u00E1fico por a\u00F1o y estado");
